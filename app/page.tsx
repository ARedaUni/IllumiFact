...
import {
  ...
  explanation2,
  explanation3,
} from "@/utils/ArticleBaseText/BaseText";
...
export default async function Home() {
  ...
  const { data }: PostgrestSingleResponse<articles[] | null> = await supabase
    .from("articles")
    .select("*");
      ...
      <div className=" flex justify-center max-w-80 sm:max-w-none flex-col items-center my-5 navconfig:!my-28">
        <div className="text-center  text-wrap  sm:!max-w-none">
          <h3 className="text-shadow  hidden sm:!visible text-2xl md:!text-4xl text-center">
            ...
            <br /> in society that threatens our democracy
            <br /> and the lives of those at home and abroad.
          </h3>
        </div>
